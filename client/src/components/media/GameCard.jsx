...
const GameCard = ({ rawg_id, title, poster_url, release_date, vote_average, platforms, showDropdown = false }) => {
  ...
  return (
    <Link to={`/games/${rawg_id}`} className={`media-card ${isDropdownOpen ? 'has-open-dropdown' : ''}`}>
      {poster_url ? (
